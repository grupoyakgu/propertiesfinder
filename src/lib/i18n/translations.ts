...
const en = {
  ...
  auth: {
    ...
    forgotPasswordSubtitle: "Enter your email address and we'll send you a link to reset it.",
    ...
    resetEmailSent: "If an account with that email exists, we've sent a password reset link.",
  ...
  analysis: {
    ...
    promptSourceLabel: "Prompt source",
    promptSourceDefaultLabel: "Built-in",
    promptSourceDefaultHint: "Uses the prompt built into the app. Changing it requires a redeploy.",
    promptSourceDatabaseLabel: "Custom (Settings)",
    promptSourceDatabaseHint: "Uses the custom prompt saved in the Admin tab's Settings. Editable there without a redeploy, in production too.",
    ...
    developmentRightsHeading: "Development rights",
    developmentRightsParameter: "Parameter",
    developmentRightsPotential: "Result",
    developmentRightsStatus: "Status",
    ...
    currentVerifiedRightsHeading: "Current verified development rights",
    ...
    keyInvestmentLimitersHeading: "Key investment limiters",
    ...
    criticalItemSourceRequiredLabel: "Source required",
    investmentBottomLineHeading: "Investment bottom line",
  ...
  investment: {
    ...
    maximumBuildableArea: "Maximum Buildable Area",
    maximumFloors: "Maximum Floors",
  ...
  admin: {
    ...
    customPromptLabel: "Custom Analysis Engine prompt",
    customPromptHint:
      "Replaces the built-in system prompt when 'Custom (Settings)' is selected as the prompt source on the Analysis Engine tab. Saved here, so it can be edited without redeploying. Leave empty to have that option fall back to the built-in prompt.",
    customPromptPlaceholder: "Paste a full replacement prompt here…",
    clearCustomPromptAction: "Clear",
    customPromptCharCount: "{n} characters",
  },
  pdf: {
...
const es: typeof en = {
  ...
  auth: {
    ...
    resetPasswordSubtitle: "Crea una nueva contraseña para tu cuenta.",
    ...
    resetEmailSent: "Si existe una cuenta con ese correo, hemos enviado un enlace para restablecer la contraseña.",
    passwordsMismatch: "Las contraseñas no coinciden",
    passwordTooShort: "La contraseña debe tener al menos 8 caracteres",
    passwordResetSuccess: "¡Contraseña restablecida con éxito! Redirigiendo a inicio de sesión...",
    invalidResetLink: "Enlace de restablecimiento inválido o caducado. Por favor, solicita uno nuevo.",
    backToLogin: "Volver a inicio de sesión",
    redirectingToLogin: "Te estamos redirigiendo a inicio de sesión...",
  ...
  analysis: {
    ...
    promptSourceLabel: "Origen del prompt",
    promptSourceDefaultLabel: "Integrado",
    promptSourceDefaultHint: "Usa el prompt integrado en la aplicación. Cambiarlo requiere un nuevo despliegue.",
    promptSourceDatabaseLabel: "Personalizado (Configuración)",
    promptSourceDatabaseHint: "Usa el prompt personalizado guardado en la Configuración de la pestaña Admin. Editable ahí sin necesidad de un despliegue, también en producción.",
    ...
    keyInvestmentLimitersHeading: "Principales limitantes de la inversión",
    ...
    criticalItemSourceRequiredLabel: "Fuente requerida",
    investmentBottomLineHeading: "Conclusión final de inversión",
  ...
  investment: {
    dashboardTitle: "Panel de Inversión",
    edificabilidad: "Edificabilidad",
    maximumBuildableArea: "Superficie Máxima Construible",
    maximumFloors: "Plantas Máximas",
  ...
  admin: {
    ...
    customPromptLabel: "Prompt personalizado del Motor de Análisis",
    customPromptHint:
      "Sustituye el prompt del sistema integrado cuando se selecciona 'Personalizado (Configuración)' como origen del prompt en la pestaña del Motor de Análisis. Se guarda aquí, por lo que puede editarse sin necesidad de un nuevo despliegue. Déjalo vacío para que esa opción use el prompt integrado.",
    customPromptPlaceholder: "Pega aquí un prompt de reemplazo completo…",
    clearCustomPromptAction: "Borrar",
    customPromptCharCount: "{n} caracteres",
  },
  pdf: {
