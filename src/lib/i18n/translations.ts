...
const en = {
  ...
  analysis: {
    ...
    promptSourceFileLabel: "File (scripts/cm4.md)",
    promptSourceFileHint: "Reads scripts/cm4.md on every run. Only redeploy-free in local dev — on the live site, editing the file still requires a redeploy.",
...
const es: typeof en = {
  ...
  analysis: {
    ...
    promptSourceFileLabel: "Archivo (scripts/cm4.md)",
    promptSourceFileHint: "Lee scripts/cm4.md en cada ejecución. Solo evita un despliegue en desarrollo local — en el sitio en producción, editar el archivo sigue requiriendo un despliegue.",
