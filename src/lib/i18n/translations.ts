...
const en = {
  ...
  analysis: {
    ...
    externalPromptLabel: "Prompt source",
    externalPromptCheckboxLabel: "Load prompt from scripts/cm4.md",
    externalPromptHint: "Lets you edit the prompt in that file without redeploying. Uncheck to use the built-in prompt.",
...
const es: typeof en = {
  ...
  analysis: {
    ...
    externalPromptLabel: "Origen del prompt",
    externalPromptCheckboxLabel: "Cargar el prompt desde scripts/cm4.md",
    externalPromptHint: "Permite editar el prompt en ese archivo sin necesidad de un nuevo despliegue. Desmárcalo para usar el prompt integrado.",
