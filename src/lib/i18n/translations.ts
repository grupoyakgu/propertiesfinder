...
const en = {
  ...
  analysis: {
    ...
    description:
      "Run an AI-powered urban planning feasibility study on one of your Opportunities — Sevilla PGOU zoning, buildability, heritage constraints, development scenarios, and a residual land value estimate.",
    noFavorites: "No opportunities to analyze yet. Add one from the Official Catastro Records tab (and make sure it isn't marked Not Relevant).",
    pickerLabel: "Select an opportunity",
...
const es: typeof en = {
  ...
  analysis: {
    ...
    description:
      "Ejecuta un estudio de viabilidad urbanística con IA sobre una de tus Oportunidades: zonificación del PGOU de Sevilla, edificabilidad, restricciones patrimoniales, escenarios de desarrollo y una estimación del valor residual del suelo.",
    noFavorites:
      "Aún no hay oportunidades para analizar. Añade una desde la pestaña de Registros Oficiales del Catastro (y asegúrate de que no esté marcada como No relevante).",
    pickerLabel: "Selecciona una oportunidad",
