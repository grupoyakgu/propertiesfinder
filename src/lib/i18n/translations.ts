...
const en = {
  ...
  dashboard: {
    ...
    drawArea: "Draw area",
    drawAreaHint: "Draw an area on the map to filter results to it, and optionally save it as a preset",
...
const es: typeof en = {
  ...
  dashboard: {
    ...
    drawAreaHint: "Dibuja un área en el mapa para filtrar los resultados a ella, y opcionalmente guárdala como ajuste",
